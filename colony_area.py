...
#Sensitivity to pixel differences
sensitivity = 145 #recommended: 125-200

#Region-of-interest when clicking
roi_size = 15  #recommended: 5-45

#Diameter of plate for reference
reference_distance_mm = 100.0  #mm (standard plate size = 100 mm)
...
def get_colony_area(event, x, y, flags, param):
    ...
    # Right-click to select a colony for deletion
